...
$url        = 'https://github.com/pritunl/pritunl-client-electron/releases/download/1.3.3637.72/Pritunl.exe'
...
$packageArgs = @{
  ...
  checksum      = 'e341bdb55373c6dfb57ae94dde914b96f41d9d294d04e5f84daee3ce12f78bef'
  checksumType  = 'sha256'
